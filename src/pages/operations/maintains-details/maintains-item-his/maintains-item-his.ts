...
@Component({
  selector: 'page-maintains-item-his',
  templateUrl: 'maintains-item-his.html',
})
export class MaintainsItemHisPage {
  pageTitle: any;
  psrId: any;
  itemId: any;
  page: number = 0;
  ...
  getItemhisList(first, refresher?) {
    ...
    this.maintainsprovider.getObjItemHis(params).subscribe((res) => {
      if (res) {
